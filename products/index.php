...
$APPLICATION->SetTitle("Временный каталог");
?>
<section class="catalog">
	<!--        <img class="catalog__image" src="--><? //=DEFAULT_TEMPLATE_PATH
													?><!--/img/catalog-image.jpg" alt="Главная картинка">-->
	<div class="container catalog__container">
		<? $APPLICATION->IncludeComponent(
			...
			array(
				...
				"UF_SORTIMAGECOUNT" => "Y",	// Номер пункта, начиная с которого будет построена навигационная цепочка
			),
			false
		); ?>

		<?
		//$elementSortField = $_GET["sort"] ? ( $_GET["sort"].',nulls') : "PROPERTY_NEW";
		...
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				"LIST_PROPERTY_CODE" => array(
					...
					3 => "UF_SORTIMAGECOUNT",
					4 => "SORTIMAGECOUNT",
					5 => "PROPERTY_SORTIMAGECOUNT",
				),
				"LIST_PROPERTY_CODEd" => "UF_SORTIMAGECOUNT",
