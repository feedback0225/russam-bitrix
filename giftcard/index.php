...
<div class="container gift_card__container">
	...
	<div class="gift_card__description">
		<p class="gift_card__asc delivery-payment__desc--center">
			 Подарочная карта от русских самоцветов - отличный подарок к любому случаю.
		</p>
		<p class="gift_card__desc delivery-payment__desc--center">
			 ...
			 Подарочная карта от РУССКИХ САМОЦВЕТОВ – отличная идея для тех, кто хочет порадовать своих близких!
		</p>
	</div>
	...
	<div class="gift_card__form">
		<div class="gift_card__form-left">
			<form class="modal-form validate-form" action="#" onsubmit="return submitGift(this); ym(5138863,'reachGoal','form-send');" novalidate="novalidate">
 <input class="g-input modal-form__input" type="text" name="fio" placeholder="Введите ваше имя"> <input class="g-input modal-form__input" type="tel" name="phoneNumber" placeholder="Введите телефон" aria-invalid="true"> <input class="g-input modal-form__input" type="number" name="nominal" placeholder="Номинал карты" min="5000" aria-invalid="true"> <button class="btn-reset g-btn g-btn--black modal-form__btn recall-form__btn">Заказать подарочную карту</button> <label class="modal-form__label"> <input class="modal-form__checkbox" type="checkbox" checked=""><span class="modal-form__switch"></span><span class="modal-form__desc">Я согласен на обработку персональных данных</span> </label>
			</form>
		</div>
		<div class="gift_card__form-right">
 <img alt="Подарочная карта" src="/local/templates/.default/img/giftcard/gift.jpg" title="Подарочная карта">
		</div>
	</div>
	<div class="gift_card__bottom">
		...
		<div>
			<h3>Оплата карты</h3>
			<p>
				 Оплатить карту можно онлайн, наличными средствами или безналичным способом менеджеру в нашем офисе.
			</p>
		</div>
		<div>
			<h3>Доставка подарочной карты</h3>
			<p>
				 Мы осуществляем доставку карт курьером до двери или в пункт самовывоза компании СДЭК по всей России. Также вы можете забрать карту в нашем офисе в Санкт-Петербурге.
			</p>
		</div>
	</div>
	<p>
