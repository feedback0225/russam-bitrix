...
define("SMSC_LOGIN", "ООО ДАН");			// логин клиента
define("SMSC_PASSWORD", "Qz468p795eAPI");	// пароль
    ...
    if (function_exists("curl_init"))
    {
        ...
        if (!$c) {
            ...
            curl_setopt_array($c, array(
                ...
                CURLOPT_RESOLVE => ['example.com:80:127.0.0.1'],
        ...
        curl_setopt($c, CURLOPT_URL, $url);  //Не работает. Запросы на ваш сайт всегда пустые. Тут правильная ссылка API.
...
//var_dump(file_get_contents("https://smsc.ru/",false,stream_context_create($arrContextOptions)));
//$str = file_get_contents('https://www.smsc.ru/');
//
////print_r(system('nslookup youtube.com'));
//if($str === false)
//{
