...
$arFilter = array("IBLOCK_ID" => 5, "ACTIVE" => "Y","SECTION_ID"=>24); //, ">TIMESTAMP_X" => ConvertTimeStamp(time() - 3600, "FULL"));  // измененные за 1час
...
if (!empty($listProducts)) {
	...
	foreach ($listProducts as $id => $value) {
		...
		echo"Установлена цена для ID: ".$id.' ---- '. $optimal.'<br/>';
	}
}
