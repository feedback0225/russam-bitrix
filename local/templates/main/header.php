...
<head>
    ...
    <?
        ...
        if(!isBot() && CModule::IncludeModule('rover.geoip')){
            ...
            if($obCache->InitCache($life_time, $cache_id, "location/" . bitrix_sessid_get(''))):
...
<div class="<?=$APPLICATION->GetCurDir() != '/order/' && $APPLICATION->GetCurDir() != '/cart/' ? 'site-container': ''?>">
            ...
            <div class="header__middle">
                <ul class="header-actions list-reset">
                    <li class="header-actions__item">
                        <a href="tel:<?echo \Bitrix\Main\Config\Option::get( "askaron.settings", $phoneNumber);?>" class="btn-reset header-actions__btn">
                ...
                <div class="tel header__tel">
                    <a class="tel__value" href="tel:<?echo \Bitrix\Main\Config\Option::get( "askaron.settings", $phoneNumber);?>"><?=\Bitrix\Main\Config\Option::get( "askaron.settings", $phoneNumber);?></a>
                    <div class="choices__list">
                        <button class="btn-reset card__no-size modal-btn" data-graph-animation="fadeInUp" data-graph-path="make-recall" data-graph-speed="500" onclick="ym(5138863,'reachGoal','form-open'); return true;">Перезвоните мне</button>
                    </div>
                ...
                <ul class="header__shop-nav shop-nav list-reset">
                    ...
                    <li class="shop-nav__item">
                        ...
                        <?else:?>
                            <button class="btn-reset shop-nav__link shop-nav__link--cabinet modal-btn" data-graph-animation="fadeInUp" data-graph-path="login-or-register" data-graph-speed="500" type="button">
                                <span class="shop-nav__icon shop-nav__icon--cabinet"></span>
            ...
            <div class="header__bottom">
                <nav class="nav nav-lock">
                    ...
                    <ul class="nav__list nav__list--dropdown list-reset js-nav-list<?if($APPLICATION->GetCurPage() == '/new/'): ?> nav__list_fornew<?endif;?>">
                                                                        ...
                                                                        <div class="menu-content js-nav-list dropdown-menu <?=$showedSubSections == 0 ? 'show': ''?>">
                                                                            <div class="menu-content__inner">
                                                                                ...
                                                                                <?if($arParentSection['UF_HEADER_SECTIONS']):?>
                                                                                    ...
                                                                                    <p class="g-title menu-content__title">коллекции</p>
                                                                                        ...
                                                                                        <div class="swiper-wrapper">
                                                                                            <?foreach ($arParentSection['UF_HEADER_SECTIONS'] as $key=>$collectionID):?>
                                                                                                ...
                                                                                                if($ar_resSS = $resSS->GetNext()): ?>
                                                                                                    <a class="swiper-slide menu-slide" href="<?=$ar_resSS['SECTION_PAGE_URL']?>">
                                                                                                        <?$image = imageX2($arParentSection['UF_COLLECTION_IMAGES'][$key])?>
                                                                                                        <div class="menu-slide__image">
                                                                                                            <img class="lozad" src="<?=IMG_LOADER?>" data-src="<?=$image[0] ? $image[0] : NO_PHOTO_PATH?>" data-srcset="<?=$image[1] ? $image[1] : NO_PHOTO_PATH?>" alt="shine"/>
                                                                                                        </div>
                                                                                ...
                                                                                <?endif;?>
                                                                                <a class="menu-content__link g-link" href="<?=$arParentSection['SECTION_PAGE_URL']?>">
                                                                                ...
                                                                                <div class="menu-content__bottom">
                                                                                    <?if($arParentSection['UF_LEFT_SECTIONS_LIST']):?>
                                                                                        <div class="menu-content__col">
                                                                                            <p class="g-title menu-content__title">Категории</p>
                                                                                            ...
                                                                                            foreach ($LCSectionIDArray as $LCSection):?>
                                                                                                ...
                                                                                                <?if($rsss->result->num_rows):?>
                                                                                                    <li class="menu-categories__item">
                                                                                                        <a class="menu-categories__link g-title" href="<?=$LCSection['SECTION_PAGE_URL']?>"><?=$LCSection['NAME']?></a>
                                                                                                    </li>
                                                                                                <?endif;?>
                                                                                            <?endforeach;?>
                                                                                        </div>
                                                                                    ...
                                                                                    <?if($arParentSection['UF_RIGHT_SECTIONS_LIST']):?>
                                                                                        <div class="menu-content__col">
                                                                                            ...
                                                                                            foreach ($RCSectionIDArray as $RCSection):?>
                                                                                                <li class="menu-categories__item">
                                                                                                    <a class="menu-categories__link g-title" href="<?=$RCSection['SECTION_PAGE_URL']?>"><?=$RCSection['NAME']?></a>
                                                                                                </li>
                                                                                            <?endforeach;?>
                                                                                        </div>
                                                                                    <?endif;?>
                                                                                    <?if($arParentSection['UF_BANNER'] && $arParentSection['UF_BANNER_LINK']):?>
                                                                                        <a class="menu-content__banner" href="<?=$arParentSection['UF_BANNER_LINK']?>">
                                                                                            <?$image = imageX2($arParentSection['UF_BANNER']);?>
                                                                                            <img class="lozad" src="<?=IMG_LOADER?>" data-src="<?=$image[0]?>" data-srcset="<?=$image[1]?> 2x" alt="New"/>
                                                                                        </a>
                                                                                    <?endif;?>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="menu-content__inner">
                                                                            ...
                                                                            <div class="menu-content__bottom">
                                                                                ...
                                                                                <?if($arParentSection['UF_BANNER']):?>
                                                                                    <a class="menu-content__banner" href="<?=$arParentSection['UF_BANNER_LINK'] ? $arParentSection['UF_BANNER_LINK'] : $arParentSection['SECTION_PAGE_URL']?>">
                                                                                        <?$image = imageX2($arParentSection['UF_BANNER'],600);?>
                                                                                        <img class="lozad" src="<?=IMG_LOADER?>" data-src="<?=$image[0]?>" alt="New"/>
                                                                                    </a>
                                                                                <?endif;?>
                                                                            </div>
                                                                        </div>
                        ...
                        <li class="nav__item"><a class="nav__link nav__link--gray" href="/products/kollektsii/ukrasheniya/">КОЛЛЕКЦИИ</a></li>
                    ...
                    <div class="tel nav-tel">
                        <a class="tel__value nav-tel__value" href="tel:<?=\Bitrix\Main\Config\Option::get( "askaron.settings", $phoneNumber);?>"><?=\Bitrix\Main\Config\Option::get( "askaron.settings", $phoneNumber);?></a>
	...
	false
        ...
        <div class="down-bar">
            ...
            <div class="down-bar__item"><a class="down-bar__link" href="/cart/"><span class="shop-nav__icon shop-nav__icon--cart"></span>Корзина</a></div>
            <div class="down-bar__item">
                <?
                global $USER;
                if($USER->IsAuthorized()):
                    ?>
                    <a class="down-bar__link" href="/login/"><span class="shop-nav__icon shop-nav__icon--cabinet"></span>Кабинет</a>
                <?else:?>
                    <button class="btn-reset down-bar__link modal-btn" data-graph-animation="fadeInUp" data-graph-path="login-or-register" data-graph-speed="500" type="button"><span class="shop-nav__icon shop-nav__icon--cabinet"></span>Вход</button>
                <?endif;?>
            </div>
        </div>
        <div class="region-selection">
            ...
            <div class="region-selection__container">
                ...
                <form class="change-city" action="#">
                    <input class="change-city__input" type="search" name="s" placeholder="Введите город" oninput="townInput(this.value)">
                ...
                <div class="cities">
                    <div class="cities-main">
                        <button onclick="setLocationByName('Москва')" class="btn-reset cities-main__btn js-region-selection__btn">МОСКВА</button>
                        <button onclick="setLocationByName('Санкт-Петербург')" class="btn-reset cities-main__btn js-region-selection__btn">Санкт-ПЕТеРБУрГ</button>
                        <button onclick="setLocationByName('Уфа')" class="btn-reset cities-main__btn js-region-selection__btn">УФА</button>
                        <button onclick="setLocationByName('Самара')" class="btn-reset cities-main__btn js-region-selection__btn">самара</button>
                        <button onclick="setLocationByName('Нижний Новгород')" class="btn-reset cities-main__btn js-region-selection__btn">нижний-новгород</button>
                    </div>
                    <div class="cities-regions g-filters">
                        <ul class="g-filters__list cities__filters list-reset">
                            ...
                            <li class="g-filters__item">
                                <button class="btn-reset g-filters__btn g-filters__btn--active" data-filters-path="region">Город</button>
                            </li>
                        </ul>
                        <div class="cities-regions__wrapper">
                            <div style="display: none" class="cities-regions__col g-filters__content" data-filters-target="city">
                                <p class="g-title g-title--center cities-regions__title">Регион</p>
                                <div class="cities-regions__letters"><a class="cities-regions__letter" href="#letter">А</a><a class="cities-regions__letter" href="#letter">Б</a><a class="cities-regions__letter" href="#letter">В</a><a class="cities-regions__letter" href="#letter">Д</a><a class="cities-regions__letter" href="#letter">Е</a><a class="cities-regions__letter" href="#letter">З</a><a class="cities-regions__letter" href="#letter">И</a><a class="cities-regions__letter" href="#letter">К</a><a class="cities-regions__letter" href="#letter">Л</a><a class="cities-regions__letter" href="#letter">М</a><a class="cities-regions__letter" href="#letter">Н</a><a class="cities-regions__letter" href="#letter">О</a><a class="cities-regions__letter" href="#letter">П</a><a class="cities-regions__letter" href="#letter">Р</a><a class="cities-regions__letter" href="#letter">С</a><a class="cities-regions__letter" href="#letter">Т</a><a class="cities-regions__letter" href="#letter">У</a><a class="cities-regions__letter" href="#letter">Х</a><a class="cities-regions__letter" href="#letter">Ч</a><a class="cities-regions__letter" href="#letter">Я</a></div>
                                <div class="cities-regions__block" data-simplebar>
                                    <div class="cities-regions__item"><span class="cities-regions__letter">А</span>
                                        <div class="cities-regions__items">
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Адыгея </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Адыгея респ. </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Алтай Алтай респ.</button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Алтайский</button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Алтайский край </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Амурская </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Амурская обл. </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Архангельская </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Архангельская обл. </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Астраханская </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Астраханская обл.</button>
                                        </div>
                                    </div>
                                    <div class="cities-regions__item"><span class="cities-regions__letter">Б</span>
                                        <div class="cities-regions__items">
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Башкортостан </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Башкортостан респ.</button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Белгородская </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Белгородская обл. </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Брянская</button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Брянская обл. </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Бурятия </button>
                                            <button class="btn-reset cities-regions__btn js-region-selection__btn">Бурятия респ. </button>
                                        </div>
                                    </div>
                            ...
                            <div class="cities-regions__col g-filters__content g-filters__content--active" data-filters-target="region">
                                <?
                                ...
                                <div class="cities-regions__letters">
                                    <?foreach ($towns as $townLetter=>$townArray):?>
                                        <a class="cities-regions__letter" href="#town<?=$townLetter?>"><?=$townLetter?></a>
                                    <?endforeach;?>
                                </div>
                                <div class="cities-regions__block" data-simplebar>
                                    <?foreach ($towns as $townLetter=>&$townArray):?>
                                        <div class="cities-regions__item" id="town<?=$townLetter?>">
                                            ...
                                            foreach ($townArray as $town):?>
                                                <button onclick="setLocationByName('<?=$town['NAME_RU']?>')" class="btn-reset cities-regions__btn js-region-selection__btn"><?=$town['NAME_RU']?></button>
                                            <?endforeach;?>
                                            </div>
                                        </div>
                                    <?endforeach;?>
